        ...
        {!showSecondContent && (
          ...
          >
            <div
              ...
              className="font-bold text-xl p-2 rounded-[9px] border  border-white shadow-sm quantico-bold text-center relative z-10"
            >
              Step onto the field <br /> Your choices decide the match
            </div>
            <Button onClick={() => sec()} title={"START"} />
            ...
            <div className="overflow-y-auto scrollbar-hide">
              <div className="flex-col gap-6 pb-20">
                ...
                <div
                  ...
                  className="font-bold text-xl p-2 rounded-[9px]  text-center border border-white shadow-sm relative z-10"
                >
                  How to Steps:
                </div>
                ...
                <div
                  ...
                  className="font-bold text-xl p-2 rounded-[9px] text-center mt-2 border border-white shadow-sm relative z-10"
                >
                  <div className="relative">
                    {steps.map((step, index) => (
                      <div
