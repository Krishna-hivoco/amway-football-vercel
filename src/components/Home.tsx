...
//                         <div className="relative flex-shrink-0">
//                           <div
//                             className={`w-12 h-12 rounded-full flex items-center justify-center font-bold text-lg transition-all duration-500 relative overflow-hidden ${
//                               currentStep >= step.id
//                                 ? "text-gray-800"
//                                 : "text-white border-4 border-white/50"
//                             }`}
//                             style={{
//                               background:
//                                 currentStep >= step.id
...
//                                 style={{
//                                   background: `conic-gradient(from 0deg, #3b82f6 0deg, #3b82f6 360deg, transparent 360deg)`,
//                                   mask: "radial-gradient(circle at center, transparent 20px, black 22px)",
//                                   WebkitMask:
//                                     "radial-gradient(circle at center, transparent 20px, black 22px)",
...
//                           {index < steps.length - 1 && (
//                             <div
//                               className={`absolute top-12 left-1/2 w-0.5 h-16 transform -translate-x-1/2 transition-all duration-500 ${
//                                 currentStep > step.id
//                                   ? "bg-blue-500"
//                                   : "bg-white/30"
//                               }`}
...
//                                 background:
//                                   currentStep > step.id
//                                     ? "linear-gradient(to bottom, #3b82f6 0%, #3b82f6 100%)"
//                                     : "rgba(255, 255, 255, 0.3)",
//                                 animation:
//                                   currentStep > step.id
//                                     ? `lineFill 0.5s ease-in-out ${
//                                         step.id * 2 - 0.5
//                                       }s forwards`
//                                     : "none",
//                               }}
...
//         @keyframes borderFillProgress {
//           0% {
//             background: conic-gradient(from -90deg, #3b82f6 0%, transparent 0%);
//           }
//           25% {
