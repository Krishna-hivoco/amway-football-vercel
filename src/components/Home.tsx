  ...
  return (
    <div className='bg-[url("/main-bg.png")] bg-no-repeat bg-cover bg-center w-full h-full flex flex-col p-7 overflow-hidden'>
       ...
       {!showSecondContent && <div
        ...
        {showSecondContent && (
          <div className="flex flex-col gap-6 phase-two-content  flex-1 justify-end">
            ...
            <div
              style={{ backgroundColor: "rgba(44, 44, 44, 0.3)" }}
              className="font-bold text-xl p-2 rounded-[9px] text-center border border-white backdrop-blur-sm shadow-sm mb-10"
            >
      ...
      <style jsx>{`
        ...
        .logo-slide-up {
          animation: logoMoveUp 0.6s ease-out forwards;
        }
